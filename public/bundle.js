...
exports.backgroundHome = '#f6c984';
exports.defaultColorText = '#ffffff';
exports.defaultHoverColorText = '#000000';
exports.capitalsColors = [
    '#b5858d',
    '#2cc8a5',
    '#f6c984',
    '#317993',
...
var App = /** @class */ (function (_super) {
    ...
    function App() {
        ...
        _this.handleStartPlaying = function () {
            var _a = _this.getNewRound(), capital = _a.capital, rightCountry = _a.rightCountry, wrongCountry = _a.wrongCountry;
            _this.setState({
                playing: true,
                capital: capital,
        ...
        _this.getNewRound = function () {
            var _a = random_1.getRandomItems(capitalsData_1.data, 2), rightCountry = _a[0], wrongCountry = _a[1];
            var capital = rightCountry.capital;
            return {
                capital: capital,
    ...
    App.prototype.render = function () {
        var _a = this.state, playing = _a.playing, capital = _a.capital, rightCountry = _a.rightCountry, wrongCountry = _a.wrongCountry, score = _a.score;
        var backgroundColors = random_1.getRandomItems(colors_1.capitalsColors, 2);
        return (React.createElement("div", null, this.state.playing ? (React.createElement(Game_1.default, { colors: backgroundColors, capital: capital, rightCountry: rightCountry, wrongCountry: wrongCountry, score: score })) : (React.createElement(Home_1.default, { handleStartPlaying: this.handleStartPlaying }))));
    };
    return App;
}(React.Component));
...
var HomeWrapper = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  width: 100vw;\n  height: 100vh;\n  background-color: ", ";\n  text-align: center;\n  padding-top: 5em;\n"], ["\n  width: 100vw;\n  height: 100vh;\n  background-color: ", ";\n  text-align: center;\n  padding-top: 5em;\n"])), colors_1.backgroundHome);
...
var Home = function (props) {
    return (React.createElement(HomeWrapper, null,
        React.createElement(H1, null, "Do you know the world's capitals?"),
        React.createElement(button_1.default, { text: "prove it", onClick: props.handleStartPlaying })));
};
...
var Button = function (props) {
    return React.createElement(ButtonWrapper, { onClick: props.onClick }, props.text);
};
...
var React = __webpack_require__(2);
var styled_components_1 = __webpack_require__(7);
var GameWrapper = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var CountriesWrapper = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  height: 100vh;\n  display: grid;\n  grid-template-columns: 50% 50%;\n"], ["\n  height: 100vh;\n  display: grid;\n  grid-template-columns: 50% 50%;\n"])));
var Country = styled_components_1.default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  background-color: ", ";\n  cursor: pointer;\n  overflow: hidden;\n  &:hover {\n    & > p:before {\n      transform: scale(10);\n    }\n  }\n  & > p {\n    text-shadow: 0 3px 0 rgba(1,1,1,0.1);\n    font-size: 5rem;\n    margin: 0px auto;\n    text-align: center;\n    margin-top: 30vh;\n    max-width: 60%;\n    position: relative;\n    &:before {\n      content: '';\n      width: 2em;\n      height: 2em;\n      background-color: rgba(255,255,255,0.2);\n      border-radius: 50%;\n      position: absolute;\n      left: calc(50% - 1em);\n      top: -.5em;\n      transition: all .3s ease-in-out;\n    }\n  }\n"], ["\n  background-color: ", ";\n  cursor: pointer;\n  overflow: hidden;\n  &:hover {\n    & > p:before {\n      transform: scale(10);\n    }\n  }\n  & > p {\n    text-shadow: 0 3px 0 rgba(1,1,1,0.1);\n    font-size: 5rem;\n    margin: 0px auto;\n    text-align: center;\n    margin-top: 30vh;\n    max-width: 60%;\n    position: relative;\n    &:before {\n      content: '';\n      width: 2em;\n      height: 2em;\n      background-color: rgba(255,255,255,0.2);\n      border-radius: 50%;\n      position: absolute;\n      left: calc(50% - 1em);\n      top: -.5em;\n      transition: all .3s ease-in-out;\n    }\n  }\n"])), function (props) { return (props.color ? props.color : "white"); });
var Capital = styled_components_1.default.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  width: 20vw;\n  height: 20vw;\n  border-radius: 50%;\n  background-color: white;\n  position: absolute;\n  margin-left: calc(50% - 10vw);\n  text-align: center;\n  margin-top: calc(50vh - 10vw);\n  & > p {\n    text-shadow: 0 3px 0 rgba(1,1,1,0.1);\n    margin: 0px;\n    margin-top: 6rem;\n    padding: 1em;\n    font-size: 1.5em;\n    color: black;\n  }\n"], ["\n  width: 20vw;\n  height: 20vw;\n  border-radius: 50%;\n  background-color: white;\n  position: absolute;\n  margin-left: calc(50% - 10vw);\n  text-align: center;\n  margin-top: calc(50vh - 10vw);\n  & > p {\n    text-shadow: 0 3px 0 rgba(1,1,1,0.1);\n    margin: 0px;\n    margin-top: 6rem;\n    padding: 1em;\n    font-size: 1.5em;\n    color: black;\n  }\n"])));
var Score = styled_components_1.default.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  position: absolute;\n  right: 1em;\n  top: 1em;\n  font-size: 2em;\n"], ["\n  position: absolute;\n  right: 1em;\n  top: 1em;\n  font-size: 2em;\n"])));
var Game = function (props) {
    var colors = props.colors, capital = props.capital, rightCountry = props.rightCountry, wrongCountry = props.wrongCountry, score = props.score;
    var coinFlipOrder = Math.random();
    return (React.createElement(GameWrapper, null,
        React.createElement(Score, null,
            "Score: ",
            score),
        React.createElement(Capital, null,
            React.createElement("p", null,
                ...
                React.createElement("br", null),
                " the capital?")),
        React.createElement(CountriesWrapper, null,
            React.createElement(Country, { color: colors[0] },
                React.createElement("p", null, coinFlipOrder > 0.5 ? rightCountry : wrongCountry)),
            React.createElement(Country, { color: colors[1] },
                React.createElement("p", null, coinFlipOrder > 0.5 ? wrongCountry : rightCountry)))));
};
...
exports.getRandomItems = function (entryArray, itemsQuantity) {
    if (itemsQuantity === void 0) { itemsQuantity = 0; }
    if (entryArray.length < itemsQuantity)
        return [];
    var itemsToReturn = [];
    for (var i = 0; i < entryArray.length; i++) {
        var validRandomElement = false;
        while (!validRandomElement) {
            var randomIndex = Math.floor(Math.random() * entryArray.length);
            var itemToReturn = entryArray[randomIndex];
