...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        var _a = this.state, playing = _a.playing, capital = _a.capital, rightCountry = _a.rightCountry, wrongCountry = _a.wrongCountry;
        var backgroundColors = random_1.getRandomItems(colors_1.capitalsColors, 2);
        return (React.createElement("div", null, this.state.playing ? (React.createElement(Game_1.default, { colors: backgroundColors, capital: capital, rightCountry: rightCountry, wrongCountry: wrongCountry })) : (React.createElement(Home_1.default, { handleStartPlaying: this.handleStartPlaying }))));
    };
    return App;
}(React.Component));
...
var Country = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  background-color: ", ";\n"], ["\n  background-color: ", ";\n"])), function (props) { return (props.color ? props.color : "white"); });
var Game = function (props) {
    var colors = props.colors, capital = props.capital, rightCountry = props.rightCountry, wrongCountry = props.wrongCountry;
    return (React.createElement(GameWrapper, null,
        React.createElement(Country, { color: colors[0] }, rightCountry),
        React.createElement(Country, { color: colors[1] }, wrongCountry)));
};
